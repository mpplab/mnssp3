...
def simple(len_motifs_sup,l_max,L_Left,L_UP,epsilon,deta,top_k,output_filename):
	l = L_Left
	N = {}
...
def main():
	...
	out_dataset_name = dataset_name + "N =%d[%d,%d]theta=%d-true"%(N,L_Left,L_UP,theta)
